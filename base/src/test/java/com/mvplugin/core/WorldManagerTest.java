...
public class WorldManagerTest extends MultiverseTest {
    ...
    public void testAddWorld() throws Exception {
        ...
        WorldManager mockWorldManager = PowerMockito.spy(new WorldManager(MultiverseCoreAPIFactory.getMockedMultiverseCoreAPI()
                , WorldManagerUtilFactory.getMockedWorldManagerUtil()));
        doAnswer(new Answer<Object>() {
            ...
            public Object answer(final InvocationOnMock invocation) throws Throwable {
                ...
                return WorldManagerUtilFactory.getMockedWorldManagerUtil().createWorld(s);
            }
        ...
        assertEquals(testAdjustSpawn, w.isAdjustSpawnEnabled());
